package eu.zavadil.openmerch.data.printPreviewZone;
...
public interface PrintPreviewZoneStubRepository extends EntityRepository<PrintPreviewZoneStub> {
	...
	default void cleanOtherPreviews(int designId, List<Integer> previewZoneIds) {
		if (previewZoneIds == null || previewZoneIds.isEmpty()) this.deleteAllByPrintPreviewId(designId);
		else this.deleteAllByPrintPreviewIdAndIdNotIn(designId, previewZoneIds);
	}
}
